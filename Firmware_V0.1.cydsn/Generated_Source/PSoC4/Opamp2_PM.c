...
#if(!Opamp2_CHECK_DEEPSLEEP_SUPPORT)
    static Opamp2_BACKUP_ Opamp2_backup =
    {
        0u, /* enableState */
    };
#endif /* (Opamp2_CHECK_DEEPSLEEP_SUPPORT) */


/*******************************************************************************
* Function Name: Opamp2_SaveConfig
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: Opamp2_RestoreConfig
********************************************************************************
*
* Summary:
*  Empty function. Included for consistency with other components.
...
*
* Global variables:
*  Opamp2_backup: The structure field 'enableState' is modified
...
{
#if(!Opamp2_CHECK_DEEPSLEEP_SUPPORT)
    if(Opamp2_CHECK_PWR_MODE_OFF)
    {
        Opamp2_backup.enableState = 1u;
        Opamp2_Stop();
    }
    else /* The component is disabled */
    {
        Opamp2_backup.enableState = 0u;
    }
#endif /* (Opamp2_CHECK_DEEPSLEEP_SUPPORT) */
}
...
*
* Global variables:
*  Opamp2_backup: The structure field 'enableState' is used to
...
{
#if(!Opamp2_CHECK_DEEPSLEEP_SUPPORT)
    if(0u != Opamp2_backup.enableState)
    {

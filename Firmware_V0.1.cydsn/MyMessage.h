...
typedef enum {
	...
	P_BYTE					= 1,	//!< Payload type is byte or bool, uint8_t
...
void        MyMessage_MyMessage1(MyMessage* message, uint8_t _sensor, uint8_t _type);
void        MyMessage_clear(MyMessage* message);
bool        MyMessage_isAck(MyMessage* message);
uint8_t     MyMessage_getCommand(MyMessage* message);
void*       MyMessage_getCustom(MyMessage* message);
const char* MyMessage_getString1(MyMessage* message);
char*       MyMessage_getCustomString(MyMessage* message, char *buffer);
char*       MyMessage_getStream(MyMessage* message, char *buffer);
char*       MyMessage_getString(MyMessage* message, char *buffer);
bool        MyMessage_getBool(MyMessage* message);
uint8_t     MyMessage_getByte(MyMessage* message);
float       MyMessage_getFloat(MyMessage* message);
int32_t     MyMessage_getLong(MyMessage* message);
uint32_t    MyMessage_getULong(MyMessage* message);
int16_t     MyMessage_getInt(MyMessage* message);
uint16_t    MyMessage_getUInt(MyMessage* message);
char        MyMessage_i2h(uint8_t i);
...
void        MyMessage_set(MyMessage* message, void* data, mysensor_payload datatype, uint8_t length, float fdata);

...
#define SHA204_SET_OUTPUT() pinMode(device_pin, OUTPUT)/#define SHA204_SET_INPUT() pinMode(device_pin, INPUT)
...
uint8_t     sha256_keyBuffer[BLOCK_LENGTH];
uint8_t     sha256_innerHash[HASH_LENGTH];
...
uint8_t     atsha204_execute(   uint8_t op_code, 
                                uint8_t param1, 
                                uint16_t param2,
                                uint8_t datalen1, 
                                uint8_t *data1, 
